         ...
         <div class="col-sm-12 col-lg-6">
            <div class="card">
               ...
               <div class="card-body">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vulputate, ex ac venenatis mollis,
                     diam nibh finibus leo</p>
                  <form :class="`row g-3 needs-validation ${validateClass}`" novalidate="">
                     <div class="col-md-6">
                     ...
                     <div class="col-12">
                        <button class="btn btn-primary" type="button" @click="Submitcustom">Submit form</button>
                     </div>
                  </form>
               </div>
            </div>
            <div class="card">
               ...
               <div class="card-body">
                  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi vulputate, ex ac venenatis mollis,
                     diam nibh finibus leo</p>
                  <form :class="`row g-3 needs-validation ${validateClass1}`" novalidate="">
                     ...
                     <div class="col-12">
                        <button class="btn btn-primary" type="button" @click="Submitcustom1">Submit form</button>
                     </div>
                  </form>
               </div>
            </div>
...
export default {
   ...
   methods: {
      ...
      checkSubmit() {
         if (this.submit) {
            this.validateClass = 'was-validated'
         } else {
            this.validateClass = ''
         }
      },
      ...
      checkSubmit1() {
         if (this.submit1) {
            this.validateClass1 = 'was-validated'
         } else {
            this.validateClass1 = ''
         }
      }
