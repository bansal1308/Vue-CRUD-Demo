            ...
            <div
               ...
               <Swiper id="swiper-wrapper-bb5b4e5553f7a9a4" aria-live="polite" :options="newoptions">
                  <SwiperSlide class="swiper-slide card card-slide swiper-slide-active" data-aos="fade-up"
                     data-aos-delay="700" role="group" aria-label="1 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-01"
                              ...
                              role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="90">
                              ...
                              <svg version="1.1" width="100" height="100" viewBox="0 0 100 100" class="circle-progress">
                                 ...
                                 <path d="M 50 4 A 46 46 0 1 1 22.96187839454623 12.785218258752423"
                                 ...
                                 <text class="circle-progress-text" x="50" y="50" font="16px Arial, sans-serif"
                                    text-anchor="middle" fill="#999" dy="0.4em">90%</text>
                              </svg>
                           </div>
                           <div class="progress-detail">
                              <p class="mb-2">Total Sales</p>
                              <h4 class="counter" style="visibility: visible;">$
                                 <Vue3autocounter ref='counter' :startAmount='0' :endAmount='560' />K
                              </h4>
                           </div>
                        </div>
                     </div>
                  </SwiperSlide>
                  <SwiperSlide class="swiper-slide card card-slide swiper-slide-next" data-aos="fade-up"
                     data-aos-delay="800" role="group" aria-label="2 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-02"
                              ...
                              role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="80">
                              ...
                              <svg version="1.1" width="100" height="100" viewBox="0 0 100 100" class="circle-progress">
                                 <circle class="circle-progress-circle" cx="50" cy="50" r="46" fill="none" stroke="#ddd"
                                    stroke-width="8"></circle>
                                 <path d="M 50 4 A 46 46 0 1 1 6.25140025042294 35.78521825875241"
                                    class="circle-progress-value" fill="none" stroke="#00E699" stroke-width="8"></path>
                                 <text class="circle-progress-text" x="50" y="50" font="16px Arial, sans-serif"
                                    text-anchor="middle" fill="#999" dy="0.4em">80%</text>
                              </svg>
                           </div>
                           <div class="progress-detail">
                              <p class="mb-2">Total Profit</p>
                              <h4 class="counter" style="visibility: visible;">$
                                 <Vue3autocounter ref='counter' :startAmount='0' :endAmount='185' />K
                              </h4>
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="progress-widget">
                           <div id="circle-progress-03"
                              ...
                              <svg version="1.1" width="100" height="100" viewBox="0 0 100 100" class="circle-progress">
                                 <circle class="circle-progress-circle" cx="50" cy="50" r="46" fill="none" stroke="#ddd"
                                    stroke-width="8"></circle>
                                 <path d="M 50 4 A 46 46 0 1 1 6.25140025042294 64.2147817412476"
                                    class="circle-progress-value" fill="none" stroke="#00E699" stroke-width="8"></path>
                                 <text class="circle-progress-text" x="50" y="50" font="16px Arial, sans-serif"
                                    text-anchor="middle" fill="#999" dy="0.4em">70%</text>
                              </svg>
                           </div>
                           <div class="progress-detail">
                              <p class="mb-2">Total Cost</p>
                              <h4 style="visibility: visible;">$
                                 <Vue3autocounter ref='counter' :startAmount='0' :endAmount='375' />K
                              </h4>
                           </div>
                        </div>
                     </div>
                  </SwiperSlide>
                  <SwiperSlide class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1000"
                     role="group" aria-label="4 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-04"
                              ...
                              <svg version="1.1" width="100" height="100" viewBox="0 0 100 100" class="circle-progress">
                                 ...
                                 <path d="M 50 4 A 46 46 0 1 1 22.96187839454624 87.21478174124758"
                                    class="circle-progress-value" fill="none" stroke="#00E699" stroke-width="8"></path>
                                 <text class="circle-progress-text" x="50" y="50" font="16px Arial, sans-serif"
                                    text-anchor="middle" fill="#999" dy="0.4em">60%</text>
                              </svg>
                           </div>
                           <div class="progress-detail">
                              <p class="mb-2">Revenue</p>
                              <h4 style="visibility: visible;">$
                                 <Vue3autocounter ref='counter' :startAmount='0' :endAmount='742' />K
                              </h4>
                           </div>
                        </div>
                     </div>
                  </SwiperSlide>
                  <SwiperSlide class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1100"
                     role="group" aria-label="5 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-05"
                              class="circle-progress-01 circle-progress circle-progress-primary text-center"
                              data-min-value="0" data-max-value="100" data-value="50" data-type="percent"
                              role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="50">
                              <svg class="card-slie-arrow " width="24px" height="24px" viewBox="0 0 24 24">
                                 <path fill="currentColor" d="M5,17.59L15.59,7H9V5H19V15H17V8.41L6.41,19L5,17.59Z">
                                 </path>
                              </svg>
                              <svg version="1.1" width="100" height="100" viewBox="0 0 100 100" class="circle-progress">
                                 <circle class="circle-progress-circle" cx="50" cy="50" r="46" fill="none" stroke="#ddd"
                                    stroke-width="8"></circle>
                                 <path d="M 50 4 A 46 46 0 0 1 50 96" class="circle-progress-value" fill="none"
                           ...
                           <div class="progress-detail">
                              ...
                              <h4 style="visibility: visible;">$
                                 <Vue3autocounter ref='counter' :startAmount='0' :endAmount='150' />K
                              </h4>
                           </div>
                        </div>
                     </div>
                  </SwiperSlide>
                  <SwiperSlide class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1200"
                     role="group" aria-label="6 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-06"
                              class="circle-progress-01 circle-progress circle-progress-info text-center"
                              data-min-value="0" data-max-value="100" data-value="40" data-type="percent"
                              role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="40">
                              <svg class="card-slie-arrow " width="24" viewBox="0 0 24 24">
                                 <path fill="currentColor" d="M19,6.41L17.59,5L7,15.59V9H5V19H15V17H8.41L19,6.41Z">
                                 </path>
                              </svg>
                              <svg version="1.1" width="100" height="100" viewBox="0 0 100 100" class="circle-progress">
                                 <circle class="circle-progress-circle" cx="50" cy="50" r="46" fill="none" stroke="#ddd"
                                    stroke-width="8"></circle>
                                 <path d="M 50 4 A 46 46 0 0 1 77.03812160545377 87.21478174124758"
                                    class="circle-progress-value" fill="none" stroke="#00E699" stroke-width="8"></path>
                                 <text class="circle-progress-text" x="50" y="50" font="16px Arial, sans-serif"
                  ...
                  <SwiperSlide class="swiper-slide card card-slide" data-aos="fade-up" data-aos-delay="1300"
                     role="group" aria-label="7 / 7" style="width: 318px; margin-right: 32px;">
                     <div class="card-body">
                        <div class="progress-widget">
                           <div id="circle-progress-07"
                              ...
                              <svg version="1.1" width="100" height="100" viewBox="0 0 100 100" class="circle-progress">
                                 <circle class="circle-progress-circle" cx="50" cy="50" r="46" fill="none" stroke="#ddd"
                                    stroke-width="8"></circle>
                                 <path d="M 50 4 A 46 46 0 0 1 93.74859974957707 64.21478174124758"
                                    class="circle-progress-value" fill="none" stroke="#00E699" stroke-width="8"></path>
                                 <text class="circle-progress-text" x="50" y="50" font="16px Arial, sans-serif"
                                    text-anchor="middle" fill="#999" dy="0.4em">30%</text>
                              </svg>
                           </div>
                           <div class="progress-detail">
                              <p class="mb-2">Members</p>
                              <h4 style="visibility: visible;">
                                 <Vue3autocounter ref='counter' :startAmount='0' :endAmount='112' />M
                              </h4>
                           </div>
                        </div>
                     </div>
                           ...
                           <tbody>
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <Progressbar :value="60" color="primary" class="shadow-none w-100"
                                       colorName="primary" style="height: 4px" />
                                 </td>
                              </tr>
                              <tr>
                                 <td>
                                 ...
                                 <td>
                                    ...
                                    <Progressbar :value="25" color="primary" class="shadow-none w-100"
                                       colorName="primary" style="height: 4px" />
                                 </td>
                              </tr>
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <Progressbar :value="100" color="success" class="shadow-none w-100"
                                       colorName="success" style="height: 4px" />
                                 </td>
                              </tr>
                              <tr>
                                 <td>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    ...
                                    <Progressbar :value="75" color="primary" class="shadow-none w-100"
                                       colorName="primary" style="height: 4px" />
                                 </td>
                              </tr>
                           </tbody>
